    ...
    <div style={{ maxWidth: 1040 }}>
      ...
      <div ref={pageRef} style={{ ...rootVars, background: PAGE, borderRadius: 16, padding: 26, fontFamily: FONT, color: INK }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
          {[['youtube', 'YOUTUBE', '@EmeriaMC'], ['twitch', 'TWITCH', 'twitch.tv/emeriamc'], ['tiktok', 'TIKTOK', '@emeriamc'], ['instagram', 'INSTAGRAM', '@emeria.mc']].map(([net, label, handle]) => (
        ...
        <div style={{ marginTop: 14 }}>
          <Item name="bandeau-reseaux" full cellStyle={{}} caption="bandeau (bas de vidéo / affiche)">
            <div style={{ display: 'flex', alignItems: 'center', gap: 18, flexWrap: 'wrap', justifyContent: 'center', padding: '18px 22px', borderRadius: 14, background: CARD_DARK, border: '1px solid rgba(124,92,255,.25)' }}>
              <Lockup s={30} dark />
              <span style={{ width: 6, height: 6, transform: 'rotate(45deg)', background: 'var(--acc)' }} />
              {[['youtube', '@EmeriaMC'], ['twitch', 'twitch.tv/emeriamc'], ['tiktok', '@emeriamc'], ['instagram', '@emeria.mc']].map(([net, handle]) => (
